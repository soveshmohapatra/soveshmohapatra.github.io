  ...
  <div class="hero-body">
    <div class="container">
      <div id="results-carousel" class="carousel results-carousel">
       <div class="item">
        <!-- Your image here -->
        <img src="/assets/TReND/1.png" alt="Schematic Flow" style="display: block; margin: 0 auto;"/>
      ...
      <div class="item">
        <!-- Your image here -->
        <img src="/assets/TReND/3.png" alt="7 Parcellation" style="display: block; margin: 0 auto;"/>
        <h4 class="subtitle has-text-centered">
     ...
     <div class="item">
      <!-- Your image here -->
      <img src="/assets/TReND/4.png" alt="19 Parcellation" style="display: block; margin: 0 auto;"/>
      <h4 class="subtitle has-text-centered">
